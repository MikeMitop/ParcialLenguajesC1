...
3. **Lexer y Parser:** FibonacciLexer divide la entrada (FIBO, (, 8, )) en tokens. FibonacciParser construye el árbol sintáctico asegurando que cumple las reglas gramaticales.
   
5. **Visitor (FibonacciVisitorImpl.py):** Recorre el árbol generado. Al llegar al nodo numérico, extrae el valor n, ejecuta un bucle iterativo de Python para calcular los n valores de la secuencia de Fibonacci y los imprime separados por comas.
